...
export default function DeleteCommunityModal() {
  const openModal = useCommunityStore((state) => state.open);
  ...
  return (
    <div>
      <Dialog
        open={openModal}
        onClose={() => {
          (setOpen(false), setCommunity(null));
        }}
                ...
                <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                  ...
                  <div className="mt-2">
                    <p className="text-gray-600  ">
                      ¿Confirmas que deseas eliminar la Comunidad? Una comunidad
                      eliminada no se puede recuperar.
                    </p>
